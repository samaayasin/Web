...
if(($row->UserID == $userID ) && ($row->CourseName == 'C++')){
    $level = $row->Level;
   $f=1;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $Query = "UPDATE courses_users SET Level = '$updatedLevel' WHERE UserID = $userID AND CourseName = 'C++'";
...
<head>
    ...
    <script defer src="C++Videos.js"></script>
...
<body onload="setV1()" onclick="fCpp()" >
...
<header>
    ...
    <div class="container" id="container1">
        ...
        <div class="text">
            Learn C++ — a versatile programming language that’s important for developing software, games, databases, and more. </div>
    </div>
    ...
    <script>
      ...
      containerSpan.textContent =  parseInt((level*100)/14)+"%";
      progressCircular.style.background =`conic-gradient(#cd5de1 ${(360*level )/14}deg, #ededed 0deg)`;
       console.log(level);
...
<nav class="sidebar">
    <div class="text">C++ Tutorial
    </div>
    <ul>
        <li ><a onclick="setV1()" href="#" >C++ Introduction</a></li>
        <li><a href="#" onclick="setV2()">Variables & Data Types</a></li>
        <li> <a href="#"  onclick="setV3()">Input & Operators</a></li>
        <li><a href="#" onclick="setV4()">Arrays, Chars & Strings</a></li>
        <li><a href="#" onclick="setV5()">References & Pointers</a></li>
        <li><a href="#" onclick="setV6()">If, Else, & Switch</a></li>
        <li><a href="#" onclick="setV7()">Loops</a></li>
        <li><a href="#" onclick="setV8()">Additional Libraries </a></li>
        <li><a href="#" onclick="setV9()">Functions simple </a></li>
        <li><a href="#" onclick="setV10()">Functions Advanced</a></li>
        <li><a href="#" onclick="setV11()">More about Functions</a></li>
        <li><a href="#" onclick="setV12()">Debugging</a></li>
        <li><a href="#" onclick="setV13()">Enum, Struct, Ascii</a></li>
        <li><a href="#" onclick="setV14()"> Classes</a></li>
    </ul>
</nav>
