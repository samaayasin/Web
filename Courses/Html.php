...
// Assuming you have a user ID stored in a variable called $userID
    ...
    for ($i = 0; $i < $result->num_rows; $i++) {
        ...
        if (($row->UserID == $userID) && ($row->CourseName == 'HTML')) {
            $level = $row->Level;
            $f = 1;
        }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $Query = "UPDATE courses_users SET Level = '$updatedLevel' WHERE UserID = $userID AND CourseName = 'HTML'";
...
<head>
    ...
    <script defer src="HtmlVideos.js"></script>
...
<body onload="setV1()" onclick="fhtm()">
...
<header>
    ...
    <div class="container hidden" id="container2">
        ...
        <div class="btn">
            ...
            <button onclick="generateCertificate('HTML')" class="certificateBtn hidden">Certificate</button>
        </div>
    ...
    <div class="container" id="container1">
        ...
        <div class="text">
            Start at the beginning by learning HTML basics — an important foundation for building and editing web pages. </div>
    </div>
    <script>
        ...
        progressCircular.style.background =`conic-gradient(#cd5de1 ${(360*level )/11}deg, #ededed 0deg)`;
        console.log(level);
    ...
    <nav class= "navbar">
        ...
        <nav class="sidebar">
            ...
            <ul>
                <li ><a onclick="setV1()" href="#" >HTML Introduction</a></li>
                <li>

                    <a href="#" onclick="setV2()"> HTML Elements</a>
                    <!--<a href="#" class="feat-btn">second
                ...
                <li> <a href="#"  onclick="setV3()" >HTML DOM </a>
                    <!---
                    <a href="#" class="serv-btn">33
                ...
                <li><a href="#" onclick="setV4()">Display Types</a></li>
                <li><a href="#" onclick="setV5()">Attributes</a></li>
                <li><a href="#" onclick="setV6()">Elements and DOM demo</a></li>
                <li><a href="#" onclick="setV7()">Semantics</a></li>
                <li><a href="#" onclick="setV8()">Semantics Demo</a></li>
                <li><a href="#" onclick="setV9()">Useful Things</a></li>
                <li><a href="#" onclick="setV10()">HEAD tag</a></li>
                <li><a href="#" onclick="setV11()">Class, ID, selectors, identifiers</a></li>
            </ul>
        </nav>
