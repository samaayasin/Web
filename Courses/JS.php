...
for($i=0;$i<$result->num_rows;$i++){
    ...
    if(($row->UserID == $userID ) && ($row->CourseName == 'JavaScript')){
        $level = $row->Level;
        $f=1;
    }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $Query = "UPDATE courses_users SET Level = '$updatedLevel' WHERE UserID = $userID AND CourseName = 'JavaScript'";
...
<head>
    ...
    <script defer src="JSVideos.js"></script>
...
<header>
    ...
    <div class="container hidden" id="container2">
        ...
        <div class="btn">
            ...
            <button onclick="generateCertificate('JavaScript')" class="certificateBtn hidden">Certificate</button>
        </div>
    ...
    <div class="container" id="container1">
        ...
        <div class="text">
            Learn how to use JavaScript — a powerful and flexible programming language for adding website interactivity. </div>
    </div>
    ...
    <script>
        ...
        progressCircular.style.background =`conic-gradient(#cd5de1 ${(360*level )/16}deg, #ededed 0deg)`;
        console.log(level);
    ...
    <nav class= "navbar">
        ...
        <nav class="sidebar">
            ...
            <ul>
                <li ><a onclick="setV1()" href="#" >JavaScript Introduction</a></li>
                <li><a href="#" onclick="setV2()">Fonts</a></li>
                <li> <a href="#"  onclick="setV3()">Borders </a></li>
                <li><a href="#" onclick="setV4()">Background</a></li>
                <li><a href="#" onclick="setV5()">DataTypes</a></li>
                <li><a href="#" onclick="setV6()">Type Conversion </a></li>
                <li><a href="#" onclick="setV7()">Arithmetic Operators</a></li>
                <li><a href="#" onclick="setV8()">Math Objects </a></li>
                <li><a href="#" onclick="setV9()">Concatenation & Appending </a></li>
                <li><a href="#" onclick="setV10()">Interpoliation</a></li>
                <li><a href="#" onclick="setV11()">Comparison Operators</a></li>
                <li><a href="#" onclick="setV12()">Logical Operators</a></li>
                <li><a href="#" onclick="setV13()">Assignment Operators</a></li>
                <li><a href="#" onclick="setV14()">Arrays & Array Methods</a></li>
                <li><a href="#" onclick="setV15()">Date And Times</a></li>
                <li><a href="#" onclick="setV16()">Conditional Statements</a></li>
                <li><a href="#" onclick="setV17()">Switch Statement</a></li>
                <li><a href="#" onclick="setV18()">Loops</a></li>
                <li><a href="#" onclick="setV19()">Functions</a></li>
                <li><a href="#" onclick="setV20()">The Window Object </a></li>
            </ul>
        </nav>
    </nav>
    <script>
