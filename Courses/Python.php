...
// Assuming you have a user ID stored in a variable called $userID
    ...
    for ($i = 0; $i < $result->num_rows; $i++) {
        ...
        if (($row->UserID == $userID) && ($row->CourseName == 'Python')) {
            $level = $row->Level;
            $f = 1;
        }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $Query = "UPDATE courses_users SET Level = '$updatedLevel' WHERE UserID = $userID AND CourseName = 'Python'";
...
<head>
    ...
    <script defer src="PythonVideos.js"></script>
...
<header>
    ...
    <div class="container hidden" id="container2">
        ...
        <div class="btn">
            ...
            <button onclick="generateCertificate('Python')" class="certificateBtn hidden">Certificate</button>
        </div>
    ...
    <div class="container" id="container1">
        ...
        <div class="text">
            Learn the basics of the world’s fastest growing and most popular programming language used by software engineers, analysts, data scientists, and machine learning engineers alike.</div>
    </div>
    <script>
        ...
        containerSpan.textContent = parseInt((level*100)/20)+"%";

        progressCircular.style.background =`conic-gradient(#cd5de1 ${(360*level )/20}deg, #ededed 0deg)`;
        console.log(level);
    ...
    <nav class= "navbar">
        ...
        <nav class="sidebar">
            <div class="text">Python Tutorial
            </div>
            <ul>
                <li ><a onclick="setV1()" href="#" >Variables & Data Types</a></li>
                <li><a href="#" onclick="setV2()"> Basic Operators</a></li>
                <li> <a href="#"  onclick="setV3()">Conditions</a></li>
                <li><a href="#" onclick="setV4()">IF/ELIF/ELSE</a></li>
                <li><a href="#" onclick="setV5()">Chained Conditionals & Nested Statements</a></li>
                <li><a href="#" onclick="setV6()">For Loops</a></li>
                <li><a href="#" onclick="setV7()">While Loops</a></li>
                <li><a href="#" onclick="setV8()">Lists & Tuples</a></li>
                <li><a href="#" onclick="setV9()">Iterations </a></li>
                <li><a href="#" onclick="setV10()">String Methods</a></li>
                <li><a href="#" onclick="setV11()">Slice Operator</a></li>
                <li><a href="#" onclick="setV12()">Functions</a></li>
                <li><a href="#" onclick="setV13()">Reading Files</a></li>
                <li><a href="#" onclick="setV14()"> Writing Files</a></li>
                <li><a href="#" onclick="setV15()">.count() & .find()</a></li>
                <li><a href="#" onclick="setV16()">Modular Programming</a></li>
                <li><a href="#" onclick="setV17()">Optional Parameters</a></li>
                <li><a href="#" onclick="setV18()">Error Handling</a></li>
                <li><a href="#" onclick="setV19()">Global vs Local Variables</a></li>
                <li><a href="#" onclick="setV20()">Classes & Objects</a></li>
            </ul>
        </nav>
    </nav>
    <script>
