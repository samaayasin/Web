...
// Assuming you have a user ID stored in a variable called $userID
    ...
    for ($i = 0; $i < $result->num_rows; $i++) {
        ...
        if (($row->UserID == $userID) && ($row->CourseName == 'SQL')) {
            $level = $row->Level;
            $f = 1;
        }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $Query = "UPDATE courses_users SET Level = '$updatedLevel' WHERE UserID = $userID AND CourseName = 'SQL'";
...
<head>
    ...
    <script defer src="SQLvideos.js"></script>
...
<body onload="setV1()" onclick="ffsql()">
...
<header>
    ...
    <div class="container hidden" id="container2">
        ...
        <div class="btn">
            ...
            <button onclick="generateCertificate('C++')" class="certificateBtn hidden">Certificate</button>
        </div>
    ...
    <div class="container" id="container1">
        ...
        <div class="text">
            In this SQL course, you’ll learn how to manage large datasets and analyze real data using the standard data management language.</div>
    ...
    <script>
        ...
        containerSpan.textContent = parseInt((level*100)/16)+"%";
    ...
    <nav class= "navbar">
        ...
        <nav class="sidebar">
            ...
            <ul>
                <li ><a onclick="setV1()" href="#" >SQL Introduction</a></li>
                <li><a href="#" onclick="setV2()"> CREATE & DROP Database</a></li>
                <li> <a href="#"  onclick="setV3()">Set Up A "Dummy" Database </a></li>
                <li><a href="#" onclick="setV4()">CREATE Table</a></li>
                <li><a href="#" onclick="setV5()">INSERT Statement</a></li>
                <li><a href="#" onclick="setV6()">UPDATE Statement</a></li>
                <li><a href="#" onclick="setV7()">SELECT & FROM</a></li>
                <li><a href="#" onclick="setV8()">WHERE and filtering data</a></li>
                <li><a href="#" onclick="setV9()">ORDER BY Sorting Keyword</a></li>
                <li><a href="#" onclick="setV10()">Normalization</a></li>
                <li><a href="#" onclick="setV11()">Primary and Foreign Keys</a></li>
                <li><a href="#" onclick="setV12()">JOINS </a></li>
                <li><a href="#" onclick="setV13()">LEFT JOINS</a></li>
                <li><a href="#" onclick="setV14()">RIGHT JOINS </a></li>
                <li><a href="#" onclick="setV15()">Aggregate Functions</a></li>
                <li><a href="#" onclick="setV16()">GROUP BY & HAVING </a></li>
