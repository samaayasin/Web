...
// Assuming you have a user ID stored in a variable called $userID
    ...
    for ($i = 0; $i < $result->num_rows; $i++) {
        ...
        if (($row->UserID == $userID) && ($row->CourseName == 'Java')) {
            $level = $row->Level;
            $f = 1;
        }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $Query = "UPDATE courses_users SET Level = '$updatedLevel' WHERE UserID = $userID AND CourseName = 'Java'";
...
<head>
    ...
    <script defer src="javaVideos.js"></script>
    <script defer src="pbar.js"></script>
...
<body onload="setV1()" onclick="fjav()">
<header>
    ...
    <div class="container hidden" id="container2">
        ...
        <div class="btn">
            ...
            <button onclick="generateCertificate('Java')" class="certificateBtn hidden">Certificate</button>
        </div>
    ...
    <div class="container" id="container1">
        ...
        <div class="text">
            Learn to code in Java:<br> a robust programming language used to create software, web and mobile apps, and more.  </div>
    </div>
    <script>
        ...
        containerSpan.textContent = parseInt((level*100)/10)+"%";
        progressCircular.style.background =`conic-gradient(#cd5de1 ${(360*level )/10}deg, #ededed 0deg)`;
        console.log(level);
    ...
    <nav class= "navbar">
        ...
        <nav class="sidebar">
            ...
            <ul>
                <li ><a onclick="setV1()" href="#" >Java Introduction</a></li>
                <li><a href="#" onclick="setV2()"> Getters and Setters</a></li>
                <li> <a href="#"  onclick="setV3()" >Method Overloading </a></li>
                <li><a href="#" onclick="setV4()">Constructors</a></li>
                <li><a href="#" onclick="setV5()">Method Overriding</a></li>
                <li><a href="#" onclick="setV6()">Generic Lists</a></li>
                <li><a href="#" onclick="setV7()">Static Data Members</a></li>
                <li><a href="#" onclick="setV8()">Creating Static Methods</a></li>
                <li><a href="#" onclick="setV9()">Extending a Class with Inheritance</a></li>
                <li><a href="#" onclick="setV10()">Intro to Polymorphism</a></li>
